...
import { AlertTriangle, Box, Check, ChevronDown, Clock, Copy, Gauge, Info, LogOut, LucideAngularModule, RefreshCw, Search, Settings, User, X } from 'lucide-angular';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    importProvidersFrom(LucideAngularModule.pick({ X, User, Box, Gauge, Clock, Search, ChevronDown, Settings, LogOut, RefreshCw, Info, AlertTriangle, Copy, Check })),
    provideToastr(),
  ],
};
